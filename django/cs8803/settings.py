"""
Django settings for cs8803 project.
...
SECRET_KEY = ')nnfv-5=ivd7$mzz^_x3b)_&&!x2*iqfioh9+t)8+ciew6&bl2'
...
ROOT_URLCONF = 'cs8803.urls'

WSGI_APPLICATION = 'cs8803.wsgi.application'
